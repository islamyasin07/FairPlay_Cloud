...
function IncidentReplayDrawer({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed right-0 top-0 z-50 h-full w-full max-w-2xl transform border-l border-slate-800 bg-slate-950/95 shadow-[0_0_40px_rgba(0,0,0,0.45)] backdrop-blur-xl transition-transform duration-300 ${
        ...
        {incident ? (
          <div className="flex h-full flex-col">
            <div className="flex items-start justify-between gap-4 border-b border-slate-800 px-6 py-5">
              ...
              <button
                onClick={onClose}
                className="rounded-2xl border border-slate-700 bg-slate-900/80 px-4 py-2 text-sm text-slate-300 transition hover:bg-slate-800 hover:text-white"
              >
                Close
              </button>
            </div>
            ...
            <div className="border-t border-slate-800 px-6 py-4">
              <div className="flex flex-wrap gap-3">
                <button className="rounded-2xl border border-cyan-500/20 bg-cyan-500/10 px-4 py-2 text-sm font-medium text-cyan-300 transition hover:bg-cyan-500/20">
                  Mark Under Review
                </button>
                <button className="rounded-2xl border border-red-500/20 bg-red-500/10 px-4 py-2 text-sm font-medium text-red-300 transition hover:bg-red-500/20">
                  Confirm Cheat
                </button>
                <button className="rounded-2xl border border-slate-700 bg-slate-900/80 px-4 py-2 text-sm font-medium text-slate-300 transition hover:bg-slate-800 hover:text-white">
                  Dismiss Incident
                </button>
              </div>
            </div>
